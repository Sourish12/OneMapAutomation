Feature: Gmail Login
  ...
  #Scenario: I login with valid credential
   ...
   Then I click on element having xpath "//span[text()='Got it, do not show again']"
   Then I should see page title as "OneMap"
   Then I wait 5 seconds for element having id "VaccinationDisplay" to display
